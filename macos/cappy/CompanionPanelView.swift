...
struct CompanionPanelView: View {
    ...
    private var permissionsCopySection: some View {
        if companionManager.hasCompletedOnboarding && companionManager.allPermissionsGranted {
            ...
            Text("You're all set. Hit Start to meet Flicky.")
                .font(.system(size: 12, weight: .medium))
                .foregroundColor(DS.Colors.textSecondary)
                .frame(maxWidth: .infinity, alignment: .leading)
            ...
            VStack(alignment: .leading, spacing: 6) {
                ...
                Text("Some permissions were revoked. Grant all four below to keep using Flicky.")
                    .font(.system(size: 11))
                    .foregroundColor(DS.Colors.textTertiary)
            ...
            VStack(alignment: .leading, spacing: 6) {
                Text("Hi, I'm Farza. This is Flicky.")
                    .font(.system(size: 12, weight: .bold))
                    .foregroundColor(DS.Colors.textSecondary)
                ...
                Text("Nothing runs in the background. Flicky only takes a screenshot when you press the hot key.")
                    .font(.system(size: 11))
